...
typedef VisibilityChangedBuilder = Widget Function(
  BuildContext context,
  VisibilityInfo visibilityInfo,
);

/// A widget that fires a visibility callback and builds its child dynamically.
///
/// This widget allows you to use a builder function that receives visibility
/// information and dynamically determines what to render.
class VisibilityDetectorBuilder extends StatefulWidget {
  /// Constructor.
  ///
  /// `key` is required to uniquely identify this widget among all
  /// [VisibilityDetector] widgets.
  ///
  /// The `builder` parameter is required to define how the widget should
  /// be built when visibility changes.
  const VisibilityDetectorBuilder({
    required Key key,
  ...
  /// The builder function invoked with the latest visibility information.
  final VisibilityChangedBuilder builder;

  @override
  State<VisibilityDetectorBuilder> createState() =>
      _VisibilityDetectorBuilderState();
}

class _VisibilityDetectorBuilderState extends State<VisibilityDetectorBuilder> {
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      key: widget.key ?? const Key(''),
      onVisibilityChanged: _onVisibilityChanged,
      child: Builder(
        builder: (context) => widget.builder(
            context, _info ?? const VisibilityInfo(key: Key(''))),
      ),
    );
  }
}
